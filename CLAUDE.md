...
└── AGENTS.md / CLAUDE.md         # 本文件 + Claude Code 兼容副本
```
...
| P2 | `android/app/src/main/cpp/AGENTS.md` | 6 个 C++ 桥接源文件清单 |
...
> Claude Code 兼容说明：`CLAUDE.md` 是本文件的等价副本，方便 Claude Code 自动加载，**请保持两者同步**。
